...
export default function Overlay({ icon, size, customName }: Props) {
  return (
    <div
      className={`group ${customName} opacity-0 absolute flex justify-center items-center top-0 left-0 h-full w-full hover:opacity-100 bg-black/60 z-10 cursor-pointer transition-all duration-300     
      `}
    >
      <span
