...
export default function BookingsFilter({ option }: Props) {
  ...
  return (
    <button
      ...
      className={` p-2 px-4 capitalize cursor-pointer border border-1 border-stone-400 focus:outline-none focus:ring focus:ring-offset-1 hover:bg-blue-700 hover:text-stone-100 hover:border-transparent text-sm rounded-md ${
